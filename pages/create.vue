				...
				<form class="form-default form-create-topic">
					...
					<div class="pt-editor">
						...
						<div class="form-group tt-value-wrapper">
							...
							<textarea v-model="form.body" name="body" class="form-control" rows="5" placeholder="Lets get started" :maxlength="max.body"></textarea>
							<span class="tt-value-input" v-text="(max.body - form.body.length)"></span>
						</div>
